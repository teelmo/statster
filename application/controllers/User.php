...
class User extends MY_Controller {
  ...
  public function profile($username) {
    ...
    if ($data = getUser($data)) {
      ...
      $data['js_include'] = array('user/profile', 'libs/highcharts.min', 'libs/peity.min', 'helpers/chart_helper', 'helpers/comment_helper', 'helpers/time_interval_helper', 'helpers/shout_helper', 'helpers/per_year_helper');

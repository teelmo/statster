...
<?php $this->load->view('templates/page_links_main'); ?>
  <div class="left_container">
    <div class="container">
       <div class="search_container full">
        <form action="/search" method="get" accept-charset="utf-8" class="search_form">
          <div class="autocomplete_container"><input type="text" class="middle search_text" autocomplete="off" tabindex="20" placeholder="Search music…" name="q" value="<?=html_escape(urldecode($q))?>" /><span class="lds-ring hidden"><div></div><div></div><div></div><div></div></span></div>
    ...
    <div class="container">
      ...
      if ($q !== '') {
        ?>
        <h2>Search: <?=html_escape(urldecode($q))?></h2>

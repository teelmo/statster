    ...
    <div class="container">
      ...
      <?=form_open('', array('class' => '', 'id' => 'addListeningForm'), array('addListeningType' => 'form'))?>
        ...
        <div>
          ...
          <input type="radio" name="addListeningFormat" value="File:Car" id="format_2" class="hidden" /><label for="format_2"><img src="/media/img/format_img/car.png" tabindex="2" class="listening_format" title="Car" alt="" /></label>

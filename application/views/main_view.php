...
<div class="main_container">
  ...
  <div class="right_container">
    ...
    <div class="container">
      ...
      <h2>Hot albums <span class="func_container"><i class="fa fa-sync-alt" id="refreshHotAlbums"></i></span></h2>
      ...
      <h2>New releases <span class="func_container"><i class="fa fa-sync-alt" id="refreshNewAlbums"></i></span></h2>
